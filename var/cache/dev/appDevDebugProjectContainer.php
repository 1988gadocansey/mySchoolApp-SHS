...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.datatable.post' => 'getApp_Datatable_PostService',
            ...
            'sg_datatables.query' => 'getSgDatatables_QueryService',
            'sg_datatables.serializer' => 'getSgDatatables_SerializerService',
            'sg_datatables.serializer.encoder.json' => 'getSgDatatables_Serializer_Encoder_JsonService',
            'sg_datatables.serializer.method' => 'getSgDatatables_Serializer_MethodService',
            'sg_datatables.twig.extension' => 'getSgDatatables_Twig_ExtensionService',
    ...
    /**
     * Gets the 'app.datatable.post' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Datatables\PostDatatable A AppBundle\Datatables\PostDatatable instance.
     */
    protected function getApp_Datatable_PostService()
    {
        return $this->services['app.datatable.post'] = new \AppBundle\Datatables\PostDatatable($this->get('security.authorization_checker'), $this->get('security.token_storage'), $this->get('translator.default'), $this->get('router'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'myschoolapp', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_91cddf1fb207d0663e7c56d677c52dab3a233cc5b84ce1fbaa0c1bf3663d7d53');
    ...
    {
        return $this->services['knp_paginator.subscriber.sliding_pagination'] = new \Knp\Bundle\PaginatorBundle\Subscriber\SlidingPaginationSubscriber(array('defaultPaginationTemplate' => 'KnpPaginatorBundle:Pagination:uikit.html.twig', 'defaultSortableTemplate' => 'KnpPaginatorBundle:Pagination:sortable_link.html.twig', 'defaultFiltrationTemplate' => 'KnpPaginatorBundle:Pagination:filtration.html.twig', 'defaultPageRange' => 5));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $o = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'e782f5cfc486b99f74fd8b184351d555c4c09bd4', 'main', array('name' => 'shalomAcademy', 'lifetime' => 3600, 'path' => '/', 'domain' => 'localhost', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $q->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => '/student', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    /**
     * Gets the 'sg_datatables.query' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sg\DatatablesBundle\Datatable\Data\DatatableDataManager A Sg\DatatablesBundle\Datatable\Data\DatatableDataManager instance.
     */
    protected function getSgDatatables_QueryService()
    {
        return $this->services['sg_datatables.query'] = new \Sg\DatatablesBundle\Datatable\Data\DatatableDataManager($this->get('request_stack'), $this->get('sg_datatables.serializer'), $this->get('twig'), array('search_on_non_visible_columns' => false, 'translation_query_hints' => false), array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'SgDatatablesBundle' => 'Sg\\DatatablesBundle\\SgDatatablesBundle', 'StofDoctrineExtensionsBundle' => 'Stof\\DoctrineExtensionsBundle\\StofDoctrineExtensionsBundle', 'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle', 'AppBundle' => 'AppBundle\\AppBundle', 'DebugBundle' => 'Symfony\\Bundle\\DebugBundle\\DebugBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle', 'DoctrineFixturesBundle' => 'Doctrine\\Bundle\\FixturesBundle\\DoctrineFixturesBundle'));
    }

    /**
     * Gets the 'sg_datatables.serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Component\Serializer\Serializer A Symfony\Component\Serializer\Serializer instance.
     */
    protected function getSgDatatables_SerializerService()
    {
        return $this->services['sg_datatables.serializer'] = new \Symfony\Component\Serializer\Serializer(array(0 => $this->get('sg_datatables.serializer.method')), array(0 => $this->get('sg_datatables.serializer.encoder.json')));
    }

    /**
     * Gets the 'sg_datatables.serializer.encoder.json' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSgDatatables_Serializer_Encoder_JsonService()
    {
        return $this->services['sg_datatables.serializer.encoder.json'] = new \Symfony\Component\Serializer\Encoder\JsonEncoder();
    }

    /**
     * Gets the 'sg_datatables.serializer.method' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSgDatatables_Serializer_MethodService()
    {
        return $this->services['sg_datatables.serializer.method'] = new \Symfony\Component\Serializer\Normalizer\GetSetMethodNormalizer();
    }

    /**
     * Gets the 'sg_datatables.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sg\DatatablesBundle\Twig\DatatableTwigExtension A Sg\DatatablesBundle\Twig\DatatableTwigExtension instance.
     */
    protected function getSgDatatables_Twig_ExtensionService()
    {
        return $this->services['sg_datatables.twig.extension'] = new \Sg\DatatablesBundle\Twig\DatatableTwigExtension($this->get('translator'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap3.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'bootstrap3.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('sg_datatables.twig.extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\sg\\datatablesbundle\\Sg\\DatatablesBundle/Resources/views'), 'SgDatatables');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e782f5cfc486b99f74fd8b184351d555c4c09bd4');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'e782f5cfc486b99f74fd8b184351d555c4c09bd4', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('575647c9c60e08.70491614')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'e782f5cfc486b99f74fd8b184351d555c4c09bd4',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'e782f5cfc486b99f74fd8b184351d555c4c09bd4',
            ...
            'knp_paginator.template.pagination' => 'KnpPaginatorBundle:Pagination:uikit.html.twig',

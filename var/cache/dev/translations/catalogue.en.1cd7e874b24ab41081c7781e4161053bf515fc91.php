...
',
  ...
  'messages' => 
  array (
    'datatables.datatable.processing' => 'Processing...',
    'datatables.datatable.lengthMenu' => 'Show _MENU_ entries',
    'datatables.datatable.zeroRecords' => 'No matching records found',
    'datatables.datatable.info' => 'Showing _START_ to _END_ of _TOTAL_ entries',
    'datatables.datatable.infoEmpty' => 'Showing 0 to 0 of 0 entries',
    'datatables.datatable.infoFiltered' => '(filtered from _MAX_ total entries)',
    'datatables.datatable.infoPostFix' => '',
    'datatables.datatable.search' => 'Search',
    'datatables.datatable.first' => 'First',
    'datatables.datatable.previous' => 'Previous',
    'datatables.datatable.next' => 'Next',
    'datatables.datatable.last' => 'Last',
    'datatables.datatable.all' => 'all',
    'datatables.bulk.confirmMsg' => 'Are you sure?',
    'datatables.bulk.selectError' => 'You need to select at least one element.',
    'datatables.bulk.ok' => 'Ok',
    'datatables.actions.title' => 'Actions',
    'datatables.actions.show' => 'Show',
    'datatables.actions.new' => 'New',
    'datatables.actions.edit' => 'Edit',
    'datatables.actions.delete' => 'Delete',
    'datatables.actions.toList' => 'Back to the list',
    'datatables.actions.save' => 'Save',
    'datatables.dialog.close' => 'Close',
    'daterange.apply' => 'Apply',
    'daterange.cancel' => 'Cancel',
    'daterange.format' => 'YYYY-MM-DD',
    'editable.tableRedraw' => 'The changes relates multiple records. The table is redraw with the new data.',
  ),
));

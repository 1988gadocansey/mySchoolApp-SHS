...
',
  ...
  'messages' => 
  array (
    'datatables.datatable.processing' => 'En cours de traitement...',
    'datatables.datatable.lengthMenu' => 'Voir _MENU_ entrées',
    'datatables.datatable.zeroRecords' => 'Aucun enregistrement trouvé',
    'datatables.datatable.info' => 'Enregistrement(s) _START_ à _END_ sur _TOTAL_',
    'datatables.datatable.infoEmpty' => 'Aucun enregistrement',
    'datatables.datatable.infoFiltered' => '(filtré sur un total de _MAX_ enregistrements)',
    'datatables.datatable.infoPostFix' => '',
    'datatables.datatable.search' => 'Rechercher',
    'datatables.datatable.first' => 'Premier',
    'datatables.datatable.previous' => 'Précédent',
    'datatables.datatable.next' => 'Suivant',
    'datatables.datatable.last' => 'Dernier',
    'datatables.datatable.all' => 'tous',
    'datatables.bulk.confirmMsg' => 'Êtes vous certain?',
    'datatables.bulk.selectError' => 'Vous devez sélectionner au moins un élément.',
    'datatables.bulk.ok' => 'Ok',
    'datatables.actions.title' => 'Actions',
    'datatables.actions.show' => 'Voir',
    'datatables.actions.new' => 'Nouveau',
    'datatables.actions.edit' => 'Modifier',
    'datatables.actions.delete' => 'Supprimer',
    'datatables.actions.toList' => 'Retour à la liste',
    'datatables.actions.save' => 'Enregistrer',
    'datatables.dialog.close' => 'Fermer',
    'daterange.apply' => 'Appliquer',
    'daterange.cancel' => 'Annuler',
    'daterange.format' => 'DD-MM-YYYY',
    'editable.tableRedraw' => 'Les changements liés à plusieurs enregistrements. Le tableau est redessiné avec les nouvelles données.',
  ),
));

    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/post')) {
            ...
            if ($pathinfo === '/post/bulk/delete') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_post_bulk_delete;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\PostController::bulkDeleteAction',  '_route' => 'post_bulk_delete',);
            }
            not_post_bulk_delete:
            ...
            // post_results
            if ($pathinfo === '/post/results') {
                return array (  '_controller' => 'AppBundle\\Controller\\PostController::indexResultsAction',  '_route' => 'post_results',);
            }
        ...
        if (0 === strpos($pathinfo, '/student')) {
            ...
            if ($pathinfo === '/student/new') {
                ...
                return array (  '_controller' => 'AppBundle\\Controller\\StudentController::newAction',  '_route' => 'student_new',);
            }
            not_student_new:
            ...
            if (preg_match('#^/student/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'student_show')), array (  '_controller' => 'AppBundle\\Controller\\StudentController::showAction',));
            }
            not_student_show:
            ...
            if (preg_match('#^/student/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'student_edit')), array (  '_controller' => 'AppBundle\\Controller\\StudentController::editAction',));
            }
            not_student_edit:
        ...
        if (0 === strpos($pathinfo, '/profile') && preg_match('#^/profile/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            ...
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'profile_show')), array (  '_controller' => 'AppBundle\\Controller\\UserController::showAction',));
        }
        not_profile_show:
        ...
        // sg_datatables_edit
        if ($pathinfo === '/sg/datatables/edit/field') {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_sg_datatables_edit;
            }

            return array (  '_controller' => 'Sg\\DatatablesBundle\\Controller\\EditableController::editAction',  '_route' => 'sg_datatables_edit',);
        }
